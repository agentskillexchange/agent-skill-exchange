...
| Making a Security Reviewed decision | [`security/review-guide.md`](security/review-guide.md) | [`examples/reviewer-evidence-packet.md`](examples/reviewer-evidence-packet.md) for passing/blocking evidence packets and [`security/trust-label-lifecycle.md`](security/trust-label-lifecycle.md) for label evidence |
